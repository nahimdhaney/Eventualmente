          ...
          <div class="form-inner">
            ...
            <form id="register-form">
              <div class="form-group">
                <label for="register-apellido" class="label-custom">Nombre</label>
                <input id="register-nombre" type="text" name="registerUsername" required>
              </div>
              <div class="form-group">
                <label for="register-apellido" class="label-custom">Apellido</label>
                <input id="register-apellido" type="text" name="register-apellido" required>
              </div>
              <div class="form-group">
