    ...
    <body>
        ...
        <div class="container">
            ...
            <div>
                ...
                <a href="/editarEventos">
                    <h1 class="my-4"> Editar Eventos
                    </h1>
                </a>                 
            </div>
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
                    <div class="card h-100">
                        <a href={{"editarEvento/".$objCat["id"]}}><img class="card-img-top" src={{"fotos/".$objCat["id"].".jpg"}} alt="Sin Imagen"></a>
                        <div class="card-body">
                            <h4 class="card-title">
                                <a href={{"editarEvento/".$objCat["id"]}} >{{$objCat["titulo"]}}</a>
                            </h4>
                        </div>
                    </div>
                </div>
